  ...
  return (
    <div className='h-auto w-full'>
      <div className='flex md:flex lg:flex xl:flex h-auto w-full text-center  m2 p-2  justify-around rounded-lg shadow-lg flex-1'>
        <div className='item-image h-36 md:h-56 lg:h-56 xl-56 w-24 md:w-48 lg:w-48 xl:w-48 pr-2'>
          ...
          <div className='quantity w-22 my-auto font-semibold tracking-wide flex-1'>
            ...
            <div className='btns-container w-22 my-auto block md:flex xl:flex lg:flex md:gap-4 lg:gap-4 '>
              <button className="btn-increase px-4 py-2 bg-green-600 rounded-md block mb-2 md:mb-0 lg:mb-0 xl:mb-0"
              ...
              </button>
              {
                ...
                <button
                  ...
                  className='opacity-70 cursor-not-allowed btn-trash text-gray-100 px-4 py-2 bg-olive-orange rounded-md block'
                >
