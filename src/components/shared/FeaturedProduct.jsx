...
const FeaturedProduct = (props) => {
    ...
    return (
        <div className="overflow-hidden items-center rounded-2xl bg-card-background shadow-lg h-auto pb-3 lg:pb-0 md:pb-6 ">
          <div className="rounded-lg center mx-auto mt-6 flex items-center w-4/5 md:h-2/4">
          ...
          <div className="px-6 py-4 mx-auto  ">
            ...
            <p className="text-gray-200 pt-2" >N {price}</p>
            
            
          </div>
          {
            !isInCart(product, cartItems) && 
            <div className="flex justify-between md:pb-2 lg:pb-2">
              <div className="add-btns text-2xl text-gray-200 flex justify-between gap-6 px-6">
                <span>+</span><span>-</span>
              </div>
              <button onClick={() => addProduct(product)} className="btn btn-primary rounded-l-full  rounded-r-none bg-olive-orange my-0">
                Order
              </button>
