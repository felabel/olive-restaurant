const SHOP_DATA = [
    {
      id: 1,
      title: 'Studio Bag',
      description: 'The Studio Bag is identical to its yadadadad . ',
    ...
    },
    {
      id: 2,
      title: 'Cumulus',
      description: 'Light as air. The Cumulus is encased in cloud-like ',
    ...
    },
    {
      ...
      description: 'For days when you just need to grab and go. ',
    ...
    },
    {
      ...
      description: 'The Stratus is encased in cloud-like waterproof nylon ',
    ...
    },
    {
      id: 5,
      title: 'Cirrus',
      description: 'The Cirrus rucksack is encased in cloud-like waterproof nylon', 
    ...
    },
    {
      id: 6,
      title: 'Mini Circle',
      description: 'The Mini Circle is the ultimate multipurpose grab and go style',
    ...
    },
    {
      id: 8,
      title: 'Sling',
      description: 'The Sling is encased in cloud-like waterproof nylon, ',
